...
entry:
  ...
  %0 = bitcast double* %x.addr to i32*, !dbg !256
  %1 = load i32* %0, align 4, !dbg !256
  ...
  br i1 %cmp, label %if.then, label %if.end7, !dbg !258

if.then:                                          ; preds = %entry
  %sub = sub nsw i32 %4, 1072693248, !dbg !260
  %5 = bitcast double* %x.addr to i32*, !dbg !260
  %add.ptr = getelementptr inbounds i32* %5, i64 1, !dbg !260
  %6 = load i32* %add.ptr, align 4, !dbg !260
  %or = or i32 %sub, %6, !dbg !260
  %cmp1 = icmp eq i32 %or, 0, !dbg !260
  br i1 %cmp1, label %if.then2, label %if.end, !dbg !260

if.then2:                                         ; preds = %if.then
  %7 = load i32* %hx, align 4, !dbg !263
  %cmp3 = icmp sgt i32 %7, 0, !dbg !263
...
if.end:                                           ; preds = %if.then
  ...
  %sub5 = fsub double %8, %9, !dbg !267
  %10 = load double* %x.addr, align 8, !dbg !267
  %11 = load double* %x.addr, align 8, !dbg !267
  %sub6 = fsub double %10, %11, !dbg !267
  %div = fdiv double %sub5, %sub6, !dbg !267
  store double %div, double* %retval, !dbg !267
  br label %return, !dbg !267

if.end7:                                          ; preds = %entry
  %cmp8 = icmp slt i32 %4, 1071644672, !dbg !268
  br i1 %cmp8, label %if.then9, label %if.else36, !dbg !268

if.then9:                                         ; preds = %if.end7
  %12 = load i32* %ix, align 4, !dbg !270
  %cmp10 = icmp sle i32 %12, 1012924416, !dbg !270
...
if.end12:                                         ; preds = %if.then9
  ...
  %mul13 = fmul double %20, 0x3F023DE10DFDF709, !dbg !274
  %add = fadd double 0x3F49EFE07501B288, %mul13, !dbg !274
  %mul14 = fmul double %19, %add, !dbg !274
  %add15 = fadd double 0xBFA48228B5688F3B, %mul14, !dbg !274
  %mul16 = fmul double %18, %add15, !dbg !274
  %add17 = fadd double 0x3FC9C1550E884455, %mul16, !dbg !274
  %mul18 = fmul double %17, %add17, !dbg !274
  %add19 = fadd double 0xBFD4D61203EB6F7D, %mul18, !dbg !274
  %mul20 = fmul double %16, %add19, !dbg !274
  %add21 = fadd double 0x3FC5555555555555, %mul20, !dbg !274
  %mul22 = fmul double %15, %add21, !dbg !274
  store double %mul22, double* %p, align 8, !dbg !274
  ...
  %mul23 = fmul double %24, 0x3FB3B8C5B12E9282, !dbg !275
  %add24 = fadd double 0xBFE6066C1B8D0159, %mul23, !dbg !275
  %mul25 = fmul double %23, %add24, !dbg !275
  %add26 = fadd double 0x40002AE59C598AC8, %mul25, !dbg !275
  %mul27 = fmul double %22, %add26, !dbg !275
  %add28 = fadd double 0xC0033A271C8A2D4B, %mul27, !dbg !275
  %mul29 = fmul double %21, %add28, !dbg !275
  %add30 = fadd double 1.000000e+00, %mul29, !dbg !275
  store double %add30, double* %q, align 8, !dbg !275
  %25 = load double* %p, align 8, !dbg !276
  %26 = load double* %q, align 8, !dbg !276
  %div31 = fdiv double %25, %26, !dbg !276
  store double %div31, double* %r, align 8, !dbg !276
  %27 = load double* %x.addr, align 8, !dbg !277
  %28 = load double* %x.addr, align 8, !dbg !277
  %29 = load double* %r, align 8, !dbg !277
  %mul32 = fmul double %28, %29, !dbg !277
  %sub33 = fsub double 0x3C91A62633145C07, %mul32, !dbg !277
  %sub34 = fsub double %27, %sub33, !dbg !277
  %sub35 = fsub double 0x3FF921FB54442D18, %sub34, !dbg !277
  store double %sub35, double* %retval, !dbg !277
  br label %return, !dbg !277

if.else36:                                        ; preds = %if.end7
  %30 = load i32* %hx, align 4, !dbg !278
  %cmp37 = icmp slt i32 %30, 0, !dbg !278
  %31 = load double* %x.addr, align 8, !dbg !280
  br i1 %cmp37, label %if.then38, label %if.else66, !dbg !278

if.then38:                                        ; preds = %if.else36
  %add39 = fadd double 1.000000e+00, %31, !dbg !280
  %mul40 = fmul double %add39, 5.000000e-01, !dbg !280
  store double %mul40, double* %z, align 8, !dbg !280
  ...
  %mul41 = fmul double %37, 0x3F023DE10DFDF709, !dbg !282
  %add42 = fadd double 0x3F49EFE07501B288, %mul41, !dbg !282
  %mul43 = fmul double %36, %add42, !dbg !282
  %add44 = fadd double 0xBFA48228B5688F3B, %mul43, !dbg !282
  %mul45 = fmul double %35, %add44, !dbg !282
  %add46 = fadd double 0x3FC9C1550E884455, %mul45, !dbg !282
  %mul47 = fmul double %34, %add46, !dbg !282
  %add48 = fadd double 0xBFD4D61203EB6F7D, %mul47, !dbg !282
  %mul49 = fmul double %33, %add48, !dbg !282
  %add50 = fadd double 0x3FC5555555555555, %mul49, !dbg !282
  %mul51 = fmul double %32, %add50, !dbg !282
  store double %mul51, double* %p, align 8, !dbg !282
  ...
  %mul52 = fmul double %41, 0x3FB3B8C5B12E9282, !dbg !283
  %add53 = fadd double 0xBFE6066C1B8D0159, %mul52, !dbg !283
  %mul54 = fmul double %40, %add53, !dbg !283
  %add55 = fadd double 0x40002AE59C598AC8, %mul54, !dbg !283
  %mul56 = fmul double %39, %add55, !dbg !283
  %add57 = fadd double 0xC0033A271C8A2D4B, %mul56, !dbg !283
  %mul58 = fmul double %38, %add57, !dbg !283
  %add59 = fadd double 1.000000e+00, %mul58, !dbg !283
  store double %add59, double* %q, align 8, !dbg !283
  ...
  %div60 = fdiv double %43, %44, !dbg !285
  store double %div60, double* %r, align 8, !dbg !285
  %45 = load double* %r, align 8, !dbg !286
  %46 = load double* %s, align 8, !dbg !286
  %mul61 = fmul double %45, %46, !dbg !286
  %sub62 = fsub double %mul61, 0x3C91A62633145C07, !dbg !286
  store double %sub62, double* %w, align 8, !dbg !286
  %47 = load double* %s, align 8, !dbg !287
  %48 = load double* %w, align 8, !dbg !287
  %add63 = fadd double %47, %48, !dbg !287
  %mul64 = fmul double 2.000000e+00, %add63, !dbg !287
  %sub65 = fsub double 0x400921FB54442D18, %mul64, !dbg !287
  store double %sub65, double* %retval, !dbg !287
  br label %return, !dbg !287

if.else66:                                        ; preds = %if.else36
  %sub67 = fsub double 1.000000e+00, %31, !dbg !288
  %mul68 = fmul double %sub67, 5.000000e-01, !dbg !288
  store double %mul68, double* %z, align 8, !dbg !288
  %49 = load double* %z, align 8, !dbg !290
  %call69 = call double @klee_internal_sqrt(double %49) #9, !dbg !290
  store double %call69, double* %s, align 8, !dbg !290
  %50 = load double* %s, align 8, !dbg !291
  store double %50, double* %df, align 8, !dbg !291
  %51 = bitcast double* %df to i32*, !dbg !292
  %add.ptr70 = getelementptr inbounds i32* %51, i64 1, !dbg !292
  store i32 0, i32* %add.ptr70, align 4, !dbg !292
  %52 = load double* %z, align 8, !dbg !293
  %53 = load double* %df, align 8, !dbg !293
  %54 = load double* %df, align 8, !dbg !293
  %mul71 = fmul double %53, %54, !dbg !293
  %sub72 = fsub double %52, %mul71, !dbg !293
  %55 = load double* %s, align 8, !dbg !293
  %56 = load double* %df, align 8, !dbg !293
  %add73 = fadd double %55, %56, !dbg !293
  %div74 = fdiv double %sub72, %add73, !dbg !293
  store double %div74, double* %c, align 8, !dbg !293
  ...
  %mul75 = fmul double %62, 0x3F023DE10DFDF709, !dbg !294
  %add76 = fadd double 0x3F49EFE07501B288, %mul75, !dbg !294
  %mul77 = fmul double %61, %add76, !dbg !294
  %add78 = fadd double 0xBFA48228B5688F3B, %mul77, !dbg !294
  %mul79 = fmul double %60, %add78, !dbg !294
  %add80 = fadd double 0x3FC9C1550E884455, %mul79, !dbg !294
  %mul81 = fmul double %59, %add80, !dbg !294
  %add82 = fadd double 0xBFD4D61203EB6F7D, %mul81, !dbg !294
  %mul83 = fmul double %58, %add82, !dbg !294
  %add84 = fadd double 0x3FC5555555555555, %mul83, !dbg !294
  %mul85 = fmul double %57, %add84, !dbg !294
  store double %mul85, double* %p, align 8, !dbg !294
  ...
  %mul86 = fmul double %66, 0x3FB3B8C5B12E9282, !dbg !295
  %add87 = fadd double 0xBFE6066C1B8D0159, %mul86, !dbg !295
  %mul88 = fmul double %65, %add87, !dbg !295
  %add89 = fadd double 0x40002AE59C598AC8, %mul88, !dbg !295
  %mul90 = fmul double %64, %add89, !dbg !295
  %add91 = fadd double 0xC0033A271C8A2D4B, %mul90, !dbg !295
  %mul92 = fmul double %63, %add91, !dbg !295
  %add93 = fadd double 1.000000e+00, %mul92, !dbg !295
  store double %add93, double* %q, align 8, !dbg !295
  %67 = load double* %p, align 8, !dbg !296
  %68 = load double* %q, align 8, !dbg !296
  %div94 = fdiv double %67, %68, !dbg !296
  store double %div94, double* %r, align 8, !dbg !296
  %69 = load double* %r, align 8, !dbg !297
  %70 = load double* %s, align 8, !dbg !297
  %mul95 = fmul double %69, %70, !dbg !297
  %71 = load double* %c, align 8, !dbg !297
  %add96 = fadd double %mul95, %71, !dbg !297
  store double %add96, double* %w, align 8, !dbg !297
  %72 = load double* %df, align 8, !dbg !298
  %73 = load double* %w, align 8, !dbg !298
  %add97 = fadd double %72, %73, !dbg !298
  %mul98 = fmul double 2.000000e+00, %add97, !dbg !298
  store double %mul98, double* %retval, !dbg !298
