; ModuleID = 'w_gamma_r.bc'
source_filename = "./w_gamma_r.c"
...
define dso_local double @gamma_r(double %x, i32* %signgamp) #0 !dbg !17 {
entry:
  ...
  %call = call double @__ieee754_gamma_r(double %0, i32* %1), !dbg !32
...
if.then6:                                         ; preds = %land.lhs.true4
  ...
  %call7 = call double @__kernel_standard(double %12, double %13, i32 41), !dbg !59
...
if.else:                                          ; preds = %land.lhs.true4, %if.then2
  ...
  %call8 = call double @__kernel_standard(double %14, double %15, i32 40), !dbg !63
...
entry:
  ...
  %call = call i32 (double, i32*, ...) bitcast (i32 (...)* @lgamma_r to i32 (double, i32*, ...)*)(double %2, i32* %a1), !dbg !82
  %conv = sitofp i32 %call to double, !dbg !82
  store double %conv, double* %r, align 8, !dbg !80
  ret i32 0, !dbg !83
}

declare dso_local void @klee_make_symbolic(i8*, i64, i8*) #2

declare dso_local i32 @lgamma_r(...) #2
...
!1 = !DIFile(filename: "w_gamma_r.c", directory: "/home/klee/logic_bombs/fdlibm")
!2 = !{!3}
...
!17 = distinct !DISubprogram(name: "gamma_r", scope: !18, file: !18, line: 22, type: !19, scopeLine: 27, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !23)
!18 = !DIFile(filename: "./w_gamma_r.c", directory: "/home/klee/logic_bombs/fdlibm")
