...
define dso_local double @sin(double %x) #0 !dbg !12 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call = call double @__kernel_sin(double %4, double %5, i32 0), !dbg !39
...
sw.bb:                                            ; preds = %if.else3
  ...
  %call7 = call double @__kernel_sin(double %11, double %12, i32 1), !dbg !60
...
sw.bb8:                                           ; preds = %if.else3
  ...
  %call11 = call double @__kernel_cos(double %13, double %14), !dbg !64
  store double %call11, double* %retval, align 8, !dbg !65
  br label %return, !dbg !65

sw.bb12:                                          ; preds = %if.else3
  %arrayidx13 = getelementptr inbounds [2 x double], [2 x double]* %y, i64 0, i64 0, !dbg !66
  %15 = load double, double* %arrayidx13, align 16, !dbg !66
  %arrayidx14 = getelementptr inbounds [2 x double], [2 x double]* %y, i64 0, i64 1, !dbg !67
  %16 = load double, double* %arrayidx14, align 8, !dbg !67
  %call15 = call double @__kernel_sin(double %15, double %16, i32 1), !dbg !68
  %fneg = fneg double %call15, !dbg !69
  store double %fneg, double* %retval, align 8, !dbg !70
  br label %return, !dbg !70

sw.default:                                       ; preds = %if.else3
  %arrayidx16 = getelementptr inbounds [2 x double], [2 x double]* %y, i64 0, i64 0, !dbg !71
  %17 = load double, double* %arrayidx16, align 16, !dbg !71
  %arrayidx17 = getelementptr inbounds [2 x double], [2 x double]* %y, i64 0, i64 1, !dbg !72
  %18 = load double, double* %arrayidx17, align 8, !dbg !72
  %call18 = call double @__kernel_cos(double %17, double %18), !dbg !73
  %fneg19 = fneg double %call18, !dbg !74
  store double %fneg19, double* %retval, align 8, !dbg !75
...
entry:
  ...
  %call = call double @sin(double %1) #3, !dbg !87
...
!1 = !DIFile(filename: "s_sin.c", directory: "/home/klee/logic_bombs/fdlibm")
!2 = !{}
!3 = !{!4}
...
!12 = distinct !DISubprogram(name: "sin", scope: !13, file: !13, line: 48, type: !14, scopeLine: 53, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!13 = !DIFile(filename: "./s_sin.c", directory: "/home/klee/logic_bombs/fdlibm")
...
!65 = !DILocation(line: 72, column: 11, scope: !58)
!66 = !DILocation(line: 73, column: 32, scope: !58)
!67 = !DILocation(line: 73, column: 37, scope: !58)
!68 = !DILocation(line: 73, column: 19, scope: !58)
!69 = !DILocation(line: 73, column: 18, scope: !58)
!70 = !DILocation(line: 73, column: 11, scope: !58)
!71 = !DILocation(line: 75, column: 25, scope: !58)
!72 = !DILocation(line: 75, column: 30, scope: !58)
!73 = !DILocation(line: 75, column: 12, scope: !58)
!74 = !DILocation(line: 75, column: 11, scope: !58)
!75 = !DILocation(line: 75, column: 4, scope: !58)
