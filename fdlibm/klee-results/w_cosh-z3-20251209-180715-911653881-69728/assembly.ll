...
define dso_local double @cosh(double %x) #0 !dbg !17 {
entry:
  ...
  %call = call double @__ieee754_cosh(double %0), !dbg !28
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %cmp2 = fcmp ogt double %5, 0x408633CE8FB9F87D, !dbg !42
...
if.then3:                                         ; preds = %if.end
  ...
  %call4 = call double @__kernel_standard(double %6, double %7, i32 5), !dbg !47
...
declare dso_local double @__ieee754_cosh(double) #2
...
entry:
  ...
  %call = call double @cosh(double %1) #3, !dbg !62
...
!1 = !DIFile(filename: "w_cosh.c", directory: "/home/klee/logic_bombs/fdlibm")
!2 = !{!3}
...
!17 = distinct !DISubprogram(name: "cosh", scope: !18, file: !18, line: 21, type: !19, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!18 = !DIFile(filename: "./w_cosh.c", directory: "/home/klee/logic_bombs/fdlibm")
...
!37 = !DILocation(line: 32, column: 48, scope: !31)
!38 = !DILocation(line: 32, column: 41, scope: !31)
...
!45 = distinct !DILexicalBlock(scope: !40, file: !18, line: 33, column: 41)
...
!52 = distinct !DISubprogram(name: "main", scope: !18, file: !18, line: 42, type: !53, scopeLine: 42, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!53 = !DISubroutineType(types: !54)
!54 = !{!5}
!55 = !DILocalVariable(name: "a0", scope: !52, file: !18, line: 43, type: !21)
!56 = !DILocation(line: 43, column: 12, scope: !52)
!57 = !DILocation(line: 44, column: 24, scope: !52)
!58 = !DILocation(line: 44, column: 5, scope: !52)
!59 = !DILocalVariable(name: "r", scope: !52, file: !18, line: 46, type: !21)
!60 = !DILocation(line: 46, column: 12, scope: !52)
!61 = !DILocation(line: 46, column: 21, scope: !52)
!62 = !DILocation(line: 46, column: 16, scope: !52)
!63 = !DILocation(line: 47, column: 5, scope: !52)
