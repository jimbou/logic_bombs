; ModuleID = 'e_lgamma.bc'
source_filename = "./e_lgamma.c"
...
define dso_local double @__ieee754_lgamma(double %x) #0 !dbg !9 {
entry:
  ...
  %call = call double @__ieee754_lgamma_r(double %0, i32* @signgam), !dbg !17
...
entry:
  ...
  %call = call double @__ieee754_lgamma(double %1), !dbg !30
...
!1 = !DIFile(filename: "e_lgamma.c", directory: "/home/klee/logic_bombs/fdlibm")
!2 = !{}
...
!9 = distinct !DISubprogram(name: "__ieee754_lgamma", scope: !10, file: !10, line: 26, type: !11, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!10 = !DIFile(filename: "./e_lgamma.c", directory: "/home/klee/logic_bombs/fdlibm")
!11 = !DISubroutineType(types: !12)
!12 = !{!13, !13}
!13 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!14 = !DILocalVariable(name: "x", arg: 1, scope: !9, file: !10, line: 26, type: !13)
!15 = !DILocation(line: 26, column: 33, scope: !9)
!16 = !DILocation(line: 32, column: 28, scope: !9)
...
!29 = !DILocation(line: 41, column: 33, scope: !19)
