...
define dso_local double @sqrt(double %x) #0 !dbg !17 {
entry:
  ...
  %call = call double @__ieee754_sqrt(double %0), !dbg !28
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %cmp2 = fcmp olt double %4, 0.000000e+00, !dbg !41
...
if.then3:                                         ; preds = %if.end
  ...
  %call4 = call double @__kernel_standard(double %5, double %6, i32 26), !dbg !46
...
declare dso_local double @__ieee754_sqrt(double) #2
...
entry:
  ...
  %call = call double @sqrt(double %1) #3, !dbg !61
...
!1 = !DIFile(filename: "w_sqrt.c", directory: "/home/klee/logic_bombs/fdlibm")
!2 = !{!3}
...
!17 = distinct !DISubprogram(name: "sqrt", scope: !18, file: !18, line: 21, type: !19, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!18 = !DIFile(filename: "./w_sqrt.c", directory: "/home/klee/logic_bombs/fdlibm")
