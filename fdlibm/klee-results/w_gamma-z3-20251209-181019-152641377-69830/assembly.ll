...
define dso_local double @gamma(double %x) #0 !dbg !17 {
entry:
  ...
  %call = call double @__ieee754_gamma_r(double %0, i32* @signgam), !dbg !28
...
if.then6:                                         ; preds = %land.lhs.true4
  ...
  %call7 = call double @__kernel_standard(double %11, double %12, i32 41), !dbg !55
...
if.else:                                          ; preds = %land.lhs.true4, %if.then2
  ...
  %call8 = call double @__kernel_standard(double %13, double %14, i32 40), !dbg !59
...
entry:
  ...
  %call = call double @gamma(double %1), !dbg !74
...
!1 = !DIFile(filename: "w_gamma.c", directory: "/home/klee/logic_bombs/fdlibm")
!2 = !{!3}
...
!17 = distinct !DISubprogram(name: "gamma", scope: !18, file: !18, line: 26, type: !19, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!18 = !DIFile(filename: "./w_gamma.c", directory: "/home/klee/logic_bombs/fdlibm")
!19 = !DISubroutineType(types: !20)
!20 = !{!21, !21}
!21 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!22 = !{}
!23 = !DILocalVariable(name: "x", arg: 1, scope: !17, file: !18, line: 26, type: !21)
!24 = !DILocation(line: 26, column: 22, scope: !17)
!25 = !DILocalVariable(name: "y", scope: !17, file: !18, line: 35, type: !21)
!26 = !DILocation(line: 35, column: 16, scope: !17)
!27 = !DILocation(line: 36, column: 31, scope: !17)
...
!73 = !DILocation(line: 54, column: 22, scope: !64)
