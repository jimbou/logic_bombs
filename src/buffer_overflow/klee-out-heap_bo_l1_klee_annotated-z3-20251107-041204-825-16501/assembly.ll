...
source_filename = "heap_bo_l1_klee_annotated.c"
...
@.str.1 = private unnamed_addr constant [28 x i8] c"heap_bo_l1_klee_annotated.c\00", align 1
...
if.then:                                          ; preds = %entry
  ...
  %call3 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.logic_bomb, i64 0, i64 0)), !dbg !41
...
entry:
  ...
  call void @llvm.dbg.declare(metadata [257 x i8]* %symvar, metadata !55, metadata !DIExpression()), !dbg !59
  %0 = bitcast [257 x i8]* %symvar to i8*, !dbg !60
  call void @klee_make_symbolic(i8* %0, i64 257, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0)), !dbg !61
  %arrayidx = getelementptr inbounds [257 x i8], [257 x i8]* %symvar, i64 0, i64 256, !dbg !62
  %1 = load i8, i8* %arrayidx, align 16, !dbg !62
  %conv = sext i8 %1 to i32, !dbg !62
  %cmp = icmp eq i32 %conv, 0, !dbg !63
  %conv1 = zext i1 %cmp to i32, !dbg !63
  %conv2 = sext i32 %conv1 to i64, !dbg !62
  call void @klee_assume(i64 %conv2), !dbg !64
  %arraydecay = getelementptr inbounds [257 x i8], [257 x i8]* %symvar, i64 0, i64 0, !dbg !65
  %call = call i32 @logic_bomb(i8* %arraydecay), !dbg !66
  ret i32 %call, !dbg !67
}
...
!3 = !DIFile(filename: "heap_bo_l1_klee_annotated.c", directory: "/home/klee/logic_bombs/src/buffer_overflow")
!4 = !{}
!5 = !{!6}
...
!46 = !DILocation(line: 22, column: 1, scope: !16)
!47 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 24, type: !48, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!48 = !DISubroutineType(types: !49)
!49 = !{!9, !9, !50}
!50 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !6, size: 64)
!51 = !DILocalVariable(name: "argc", arg: 1, scope: !47, file: !3, line: 24, type: !9)
!52 = !DILocation(line: 24, column: 14, scope: !47)
!53 = !DILocalVariable(name: "argv", arg: 2, scope: !47, file: !3, line: 24, type: !50)
!54 = !DILocation(line: 24, column: 27, scope: !47)
!55 = !DILocalVariable(name: "symvar", scope: !47, file: !3, line: 25, type: !56)
!56 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7, size: 2056, elements: !57)
!57 = !{!58}
!58 = !DISubrange(count: 257)
!59 = !DILocation(line: 25, column: 6, scope: !47)
!60 = !DILocation(line: 26, column: 20, scope: !47)
!61 = !DILocation(line: 26, column: 1, scope: !47)
!62 = !DILocation(line: 27, column: 13, scope: !47)
!63 = !DILocation(line: 27, column: 24, scope: !47)
!64 = !DILocation(line: 27, column: 1, scope: !47)
!65 = !DILocation(line: 28, column: 19, scope: !47)
!66 = !DILocation(line: 28, column: 8, scope: !47)
