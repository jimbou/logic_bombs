...
define dso_local i64 @f(i64 %x) #0 !dbg !9 {
entry:
  %retval = alloca i64, align 8
  %x.addr = alloca i64, align 8
  store i64 %x, i64* %x.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %x.addr, metadata !13, metadata !DIExpression()), !dbg !14
  %0 = load i64, i64* %x.addr, align 8, !dbg !15
  %rem = srem i64 %0, 2, !dbg !17
  %cmp = icmp eq i64 %rem, 0, !dbg !18
  br i1 %cmp, label %if.then, label %if.else, !dbg !19

if.then:                                          ; preds = %entry
  %1 = load i64, i64* %x.addr, align 8, !dbg !20
  %div = sdiv i64 %1, 2, !dbg !21
  store i64 %div, i64* %retval, align 8, !dbg !22
  br label %return, !dbg !22

if.else:                                          ; preds = %entry
  %2 = load i64, i64* %x.addr, align 8, !dbg !23
  %rem1 = srem i64 %2, 3, !dbg !25
  %cmp2 = icmp eq i64 %rem1, 0, !dbg !26
  br i1 %cmp2, label %if.then3, label %if.else5, !dbg !27

if.then3:                                         ; preds = %if.else
  %3 = load i64, i64* %x.addr, align 8, !dbg !28
  %div4 = sdiv i64 %3, 3, !dbg !29
  store i64 %div4, i64* %retval, align 8, !dbg !30
  br label %return, !dbg !30

if.else5:                                         ; preds = %if.else
  %4 = load i64, i64* %x.addr, align 8, !dbg !31
  %mul = mul nsw i64 3, %4, !dbg !32
  %add = add nsw i64 %mul, 1, !dbg !33
  store i64 %add, i64* %retval, align 8, !dbg !34
  br label %return, !dbg !34

return:                                           ; preds = %if.else5, %if.then3, %if.then
  %5 = load i64, i64* %retval, align 8, !dbg !35
  ret i64 %5, !dbg !35
}
...
entry:
  ...
  %0 = load i8*, i8** %s.addr, align 8, !dbg !46
  ...
  call void @llvm.dbg.declare(metadata i64* %j, metadata !51, metadata !DIExpression()), !dbg !52
  %3 = load i32, i32* %symvar, align 4, !dbg !53
  %conv1 = sext i32 %3 to i64, !dbg !53
  %call = call i64 @f(i64 %conv1), !dbg !54
  store i64 %call, i64* %j, align 8, !dbg !52
...
while.cond:                                       ; preds = %while.body, %entry
  %4 = load i64, i64* %j, align 8, !dbg !58
  %cmp = icmp ne i64 %4, 1, !dbg !59
  br i1 %cmp, label %while.body, label %while.end, !dbg !57

while.body:                                       ; preds = %while.cond
  %5 = load i64, i64* %j, align 8, !dbg !60
  %call3 = call i64 @f(i64 %5), !dbg !62
  store i64 %call3, i64* %j, align 8, !dbg !63
...
while.end:                                        ; preds = %while.cond
  ...
  %cmp4 = icmp eq i32 %7, 25, !dbg !70
  br i1 %cmp4, label %if.then, label %if.else, !dbg !71

if.then:                                          ; preds = %while.end
  %call6 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0), i32 26, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.logic_bomb, i64 0, i64 0)), !dbg !72
  br label %if.end, !dbg !72

if.else:                                          ; preds = %while.end
  %call7 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0), i32 28, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.logic_bomb, i64 0, i64 0)), !dbg !73
  br label %if.end
...
entry:
  ...
  call void @klee_make_symbolic(i8* %0, i64 5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)), !dbg !89
  %arrayidx = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 4, !dbg !90
  ...
  %conv2 = sext i32 %conv1 to i64, !dbg !90
  call void @klee_assume(i64 %conv2), !dbg !92
  %arraydecay = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 0, !dbg !93
