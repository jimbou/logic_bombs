...
@.str.1 = private unnamed_addr constant [58 x i8] c"Starting KLEE symbolic execution with array jump example\0A\00", align 1
@.str.2 = private unnamed_addr constant [2 x i8] c"s\00", align 1
@.str.3 = private unnamed_addr constant [30 x i8] c"Widened s[0] to range 0..255\0A\00", align 1
...
if.then5:                                         ; preds = %if.then
  %call6 = call i32 (i32, ...) bitcast (i32 (...)* @klee_assert to i32 (i32, ...)*)(i32 0), !dbg !51
...
if.end7:                                          ; preds = %if.end, %flag_0
  %call8 = call i32 (i32, ...) bitcast (i32 (...)* @klee_assert to i32 (i32, ...)*)(i32 0), !dbg !55
...
declare dso_local i32 @klee_assert(...) #3
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([58 x i8], [58 x i8]* @.str.1, i64 0, i64 0)), !dbg !61
  ...
  %call1 = call i32 (i8*, i64, i8*, ...) bitcast (i32 (...)* @klee_make_symbolic to i32 (i8*, i64, i8*, ...)*)(i8* %arraydecay, i64 5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)), !dbg !68
...
if.then:                                          ; preds = %for.body
  ...
  %call27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.3, i64 0, i64 0)), !dbg !101
