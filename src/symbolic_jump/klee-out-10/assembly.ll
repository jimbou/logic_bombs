...
@.str.3 = private unnamed_addr constant [3 x i8] c"s0\00", align 1
...
entry:
  ...
  %arrayidx = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 0, !dbg !72
  call void @klee_make_symbolic(i8* %arrayidx, i64 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)), !dbg !73
  %arrayidx1 = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 0, !dbg !74
  %0 = load i8, i8* %arrayidx1, align 1, !dbg !74
  %conv = sext i8 %0 to i32, !dbg !74
  %cmp = icmp sge i32 %conv, 0, !dbg !75
  %conv2 = zext i1 %cmp to i32, !dbg !75
  %conv3 = sext i32 %conv2 to i64, !dbg !74
  call void @klee_assume(i64 %conv3), !dbg !76
  %arrayidx4 = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 0, !dbg !77
  %1 = load i8, i8* %arrayidx4, align 1, !dbg !77
  %conv5 = sext i8 %1 to i32, !dbg !77
  %cmp6 = icmp sle i32 %conv5, 255, !dbg !78
  %conv7 = zext i1 %cmp6 to i32, !dbg !78
  %conv8 = sext i32 %conv7 to i64, !dbg !77
  call void @klee_assume(i64 %conv8), !dbg !79
  %arrayidx9 = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 1, !dbg !80
  store i8 65, i8* %arrayidx9, align 1, !dbg !81
  %arrayidx10 = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 2, !dbg !82
  store i8 66, i8* %arrayidx10, align 1, !dbg !83
  %arrayidx11 = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 3, !dbg !84
  store i8 67, i8* %arrayidx11, align 1, !dbg !85
  %arrayidx12 = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 4, !dbg !86
  store i8 0, i8* %arrayidx12, align 1, !dbg !87
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp13 = icmp slt i32 %2, 256, !dbg !94
  br i1 %cmp13, label %for.body, label %for.end, !dbg !95

for.body:                                         ; preds = %for.cond
  %arrayidx15 = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 0, !dbg !96
  %3 = load i8, i8* %arrayidx15, align 1, !dbg !96
  %conv16 = sext i8 %3 to i32, !dbg !96
  %4 = load i32, i32* %i, align 4, !dbg !99
  %cmp17 = icmp eq i32 %conv16, %4, !dbg !100
  br i1 %cmp17, label %if.then, label %if.end, !dbg !101

if.then:                                          ; preds = %for.body
  %arraydecay = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 0, !dbg !102
  %call = call i32 @logic_bomb(i8* %arraydecay), !dbg !104
...
!72 = !DILocation(line: 33, column: 25, scope: !64)
!73 = !DILocation(line: 33, column: 5, scope: !64)
!74 = !DILocation(line: 36, column: 17, scope: !64)
!75 = !DILocation(line: 36, column: 22, scope: !64)
!76 = !DILocation(line: 36, column: 5, scope: !64)
!77 = !DILocation(line: 37, column: 17, scope: !64)
!78 = !DILocation(line: 37, column: 22, scope: !64)
!79 = !DILocation(line: 37, column: 5, scope: !64)
!80 = !DILocation(line: 40, column: 5, scope: !64)
!81 = !DILocation(line: 40, column: 10, scope: !64)
!82 = !DILocation(line: 41, column: 5, scope: !64)
!83 = !DILocation(line: 41, column: 10, scope: !64)
!84 = !DILocation(line: 42, column: 5, scope: !64)
!85 = !DILocation(line: 42, column: 10, scope: !64)
!86 = !DILocation(line: 43, column: 5, scope: !64)
!87 = !DILocation(line: 43, column: 10, scope: !64)
!88 = !DILocalVariable(name: "i", scope: !89, file: !1, line: 46, type: !12)
!89 = distinct !DILexicalBlock(scope: !64, file: !1, line: 46, column: 5)
!90 = !DILocation(line: 46, column: 14, scope: !89)
!91 = !DILocation(line: 46, column: 10, scope: !89)
!92 = !DILocation(line: 46, column: 21, scope: !93)
!93 = distinct !DILexicalBlock(scope: !89, file: !1, line: 46, column: 5)
!94 = !DILocation(line: 46, column: 23, scope: !93)
!95 = !DILocation(line: 46, column: 5, scope: !89)
!96 = !DILocation(line: 47, column: 13, scope: !97)
!97 = distinct !DILexicalBlock(scope: !98, file: !1, line: 47, column: 13)
!98 = distinct !DILexicalBlock(scope: !93, file: !1, line: 46, column: 35)
!99 = !DILocation(line: 47, column: 21, scope: !97)
!100 = !DILocation(line: 47, column: 18, scope: !97)
!101 = !DILocation(line: 47, column: 13, scope: !98)
!102 = !DILocation(line: 49, column: 24, scope: !103)
!103 = distinct !DILexicalBlock(scope: !97, file: !1, line: 47, column: 24)
!104 = !DILocation(line: 49, column: 13, scope: !103)
!105 = !DILocation(line: 50, column: 9, scope: !103)
!106 = !DILocation(line: 51, column: 5, scope: !98)
!107 = !DILocation(line: 46, column: 31, scope: !93)
!108 = !DILocation(line: 46, column: 5, scope: !93)
!109 = distinct !{!109, !95, !110, !111}
!110 = !DILocation(line: 51, column: 5, scope: !89)
!111 = !{!"llvm.loop.mustprogress"}
!112 = !DILocation(line: 53, column: 5, scope: !64)
