...
@.str = private unnamed_addr constant [21 x i8] c"Logic bomb triggered\00", align 1
@.str.1 = private unnamed_addr constant [22 x i8] c"Path without the bomb\00", align 1
...
if.then:                                          ; preds = %land.lhs.true
  %call5 = call i32 (i32, i8*, ...) bitcast (i32 (...)* @klee_assert_msg to i32 (i32, i8*, ...)*)(i32 0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0)), !dbg !33
  br label %if.end, !dbg !35

if.else:                                          ; preds = %land.lhs.true, %entry
  %call6 = call i32 (i32, i8*, ...) bitcast (i32 (...)* @klee_assert_msg to i32 (i32, i8*, ...)*)(i32 0, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i64 0, i64 0)), !dbg !36
  br label %if.end
...
declare dso_local i32 @klee_assert_msg(...) #3
...
entry:
  ...
  call void @llvm.dbg.declare(metadata [5 x i8]* %s, metadata !47, metadata !DIExpression()), !dbg !51
  %0 = bitcast [5 x i8]* %s to i8*, !dbg !52
  call void @klee_make_symbolic(i8* %0, i64 5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)), !dbg !53
  %arrayidx = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 4, !dbg !54
  ...
  %conv2 = sext i32 %conv1 to i64, !dbg !54
  call void @klee_assume(i64 %conv2), !dbg !56
  %arraydecay = getelementptr inbounds [5 x i8], [5 x i8]* %s, i64 0, i64 0, !dbg !57
  %call = call i32 @logic_bomb(i8* %arraydecay), !dbg !58
  ret i32 %call, !dbg !59
}
...
!37 = distinct !DILexicalBlock(scope: !27, file: !1, line: 16, column: 10)
!38 = !DILocation(line: 19, column: 1, scope: !9)
!39 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 21, type: !40, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!40 = !DISubroutineType(types: !41)
!41 = !{!12, !12, !42}
!42 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !13, size: 64)
!43 = !DILocalVariable(name: "argc", arg: 1, scope: !39, file: !1, line: 21, type: !12)
!44 = !DILocation(line: 21, column: 14, scope: !39)
!45 = !DILocalVariable(name: "argv", arg: 2, scope: !39, file: !1, line: 21, type: !42)
!46 = !DILocation(line: 21, column: 27, scope: !39)
!47 = !DILocalVariable(name: "s", scope: !39, file: !1, line: 22, type: !48)
!48 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 40, elements: !49)
!49 = !{!50}
!50 = !DISubrange(count: 5)
!51 = !DILocation(line: 22, column: 6, scope: !39)
!52 = !DILocation(line: 23, column: 20, scope: !39)
!53 = !DILocation(line: 23, column: 1, scope: !39)
!54 = !DILocation(line: 24, column: 13, scope: !39)
!55 = !DILocation(line: 24, column: 17, scope: !39)
!56 = !DILocation(line: 24, column: 1, scope: !39)
!57 = !DILocation(line: 25, column: 19, scope: !39)
